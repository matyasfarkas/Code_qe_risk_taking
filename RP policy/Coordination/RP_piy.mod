...
bby = 0.0000;
                                             nu = 1.00000000000000;
rhoz = 0.95000000000000;    sigmaz = 0.0010000000000; sigma_a = 0.50000000000000;
...
omega = 0;
varsigma = 0.01000000000000;  mu_ss = 0.02500000000000;
%%%%%%%%%%%%%%
alphatemp = alpha_ss;
mutemp = mu_ss;
...
osr_params lam_pi lam_y  lam_r omega;
