...
T3 = (-1);
T611 = getPowerDeriv(T90,T71,1);
T616 = getPowerDeriv(T100,T71,1);
T619 = getPowerDeriv(y(4),params(20),1);
T688 = 1/y(5)-1/(y(5));
T695 = T3/y(5)-T3/(y(5));
T761 = getPowerDeriv(y(12)*y(13),params(10)*(1+params(6)),1);
T770 = getPowerDeriv(y(12),1-params(10),1);
T781 = getPowerDeriv(y(12),1-params(16),1);
T800 = getPowerDeriv(y(13),1-params(10),1);
T929 = getPowerDeriv(y(30),params(19),1);
T1025 = ((y(47))-y(47))/((y(47))*(y(47)))/(y(47)/(y(47)));
  ...
  g1(8,4)=(-(T88*getPowerDeriv(y(4),1+params(6),1)*T611));
  g1(8,12)=(-(T611*T84*y(13)*T761));
  g1(8,13)=(-(T611*T84*y(12)*T761));
  g1(8,38)=1-T611*params(2)*params(11)*getPowerDeriv(y(38),1+params(10)*params(6),1);
  g1(9,4)=(-(T98*y(18)*T96*T616));
  g1(9,12)=(-(T616*y(18)*y(4)*T96*getPowerDeriv(y(12),params(10)-1,1)));
  g1(9,13)=(-(T616*T98*y(18)*y(4)*getPowerDeriv(y(13),params(10),1)));
  g1(9,18)=(-(T616*T98*y(4)*T96));
  g1(9,39)=1-T616*params(2)*params(11)*getPowerDeriv(y(39),1+params(10)*params(6),1);
  g1(10,12)=T105*T770-T105*params(11)*T770;
  g1(10,13)=T104*T800-params(11)*T104*T800;
  ...
  g1(14,12)=T781-params(17)*T781;
  g1(14,34)=(-((1-params(17))*getPowerDeriv(y(34),1-params(16),1)));
  g1(15,4)=(-(T168*T164*T158*T619));
  g1(15,11)=1;
  ...
  g1(16,30)=(-(T168*T164*T175*y(23)*exp(y(40))*params(20)*T929));
  g1(16,40)=(-(T168*T164*y(23)*exp(y(40))*params(20)*T172*T175));
  g1(17,4)=(-(T168*T185*T172*y(23)*exp(y(40))*params(21)*T619));
  g1(17,14)=1;
  g1(17,23)=(-(T168*T185*T160*T172*exp(y(40))*params(21)));
  g1(17,30)=(-(T168*T185*T160*y(23)*exp(y(40))*params(21)*T929));
  g1(17,40)=(-(T168*T160*T172*y(23)*exp(y(40))*params(21)*T185));
  g1(18,4)=(-(T195*T164*T172*y(23)*exp(y(40))*params(22)*T619));
  g1(18,15)=1;
  g1(18,23)=(-(T195*T164*T160*T172*exp(y(40))*params(22)));
  g1(18,30)=(-(T195*T164*T160*y(23)*exp(y(40))*params(22)*T929));
  ...
  g1(29,41)=T3;
  g1(29,47)=T1025-params(27)*T1025;
  g1(30,16)=1;
  g1(30,47)=T3;
  g1(31,4)=(-(T168*T164*exp(y(40))*T172*T619));
  g1(31,5)=1;
  g1(31,30)=(-(T168*T164*T160*exp(y(40))*T929));
  ...
  g1(44,6)=params(42)*T688;
  g1(44,7)=params(42)*T695;
  g1(44,46)=1;
  g1(45,5)=(-(params(41)*((y(5)*(-y(48))-(y(6)-y(7)-y(5)*y(48)))/(y(5)*y(5))-(-((y(6))-(y(7))))/((y(5))*(y(5))))));
  g1(45,6)=(-(params(41)*T688));
  g1(45,7)=(-(params(41)*T695));
  ...
  g1(130,129)=T3;
  g1(130,130)=1;
  g1(131,1)=(-((1-params(1))/(y(1)-y(1)*params(1))-(-(params(20)*params(5)*(1-params(1)*params(2))*params(12)*params(5)*(1-params(1))))/(params(5)*y(1)*(1-params(1))*params(12)*params(5)*y(1)*(1-params(1))*params(12))/(1+params(6))));
  g1(131,20)=(-(params(4)*(-y(22))/(y(20)*y(20))/T22));
  g1(131,22)=(-(params(4)*1/y(20)/T22));
  g1(131,131)=1;
  g1(132,131)=(-(1+params(2)));
  g1(132,132)=1;
  if ~isreal(g1)
