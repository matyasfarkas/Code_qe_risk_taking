...
bigR = 1.00000000000000; 
bby = 0.0000;
                                             nu = 1.00000000000000;
rhoz = 0.95000000000000;    sigmaz = 0.00350000000000; sigma_a = 0.50000000000000;
rhomp = 0.00000000000000;  sigmamp = 0.00160000000000; rhobk = 0.90000000000000;  sigmabk = 0.90000000000000; alpha_ss = 0.99300000000000;
Chi =  15.0000000000000;            epsb = 10.0000000000000;      Btopbar =  3.8046172500000; Blowbar = 0.0000; 
omega = -32.45883201033217;     varsigma = 0.00000000000000;  mu_ss = 0.02500000000000;
CBBSp = -0.81000000000000;
%%%%%%%%%%%%%%
alphatemp = alpha_ss;
mutemp = mu_ss;
...
stoch_simul(order=2,irf = 0,hp_filter = 1600)  Y I q gammag bigA TL bigN Rd infl mu alpha;
options_.debug = 1;
