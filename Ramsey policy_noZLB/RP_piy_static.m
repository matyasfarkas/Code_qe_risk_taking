function [residual, g1, g2, g3] = RP_piy_static(y, x, params)
%
...
T3 = (-1);
T581 = getPowerDeriv(T90,T71,1);
T586 = getPowerDeriv(T100,T71,1);
T589 = getPowerDeriv(y(4),params(20),1);
T658 = 1/y(5)-1/(y(5));
T665 = T3/y(5)-T3/(y(5));
T731 = getPowerDeriv(y(12)*y(13),params(10)*(1+params(6)),1);
T740 = getPowerDeriv(y(12),1-params(10),1);
T751 = getPowerDeriv(y(12),1-params(16),1);
T770 = getPowerDeriv(y(13),1-params(10),1);
T837 = y(22)/y(20)*y(22)/y(20);
T893 = getPowerDeriv(y(30),params(19),1);
T989 = ((y(47))-y(47))/((y(47))*(y(47)))/(y(47)/(y(47)));
  g1(1,1)=(-(1-params(1)))/((y(1)-y(1)*params(1))*(y(1)-y(1)*params(1)))-(-(params(1)*params(2)*(1-params(1))))/((y(1)-y(1)*params(1))*(y(1)-y(1)*params(1)));
  g1(1,18)=T3;
  g1(2,16)=(-y(18));
  g1(2,18)=(-(y(16)-1));
  g1(2,20)=(-(params(4)*(-y(22))/(y(20)*y(20))))/T837;
  g1(2,22)=(-(params(4)*1/y(20)))/T837;
  g1(3,11)=1;
  g1(3,29)=(-params(8));
  ...
  g1(8,4)=(-(T88*getPowerDeriv(y(4),1+params(6),1)*T581));
  g1(8,12)=(-(T581*T84*y(13)*T731));
  g1(8,13)=(-(T581*T84*y(12)*T731));
  g1(8,38)=1-T581*params(2)*params(11)*getPowerDeriv(y(38),1+params(10)*params(6),1);
  g1(9,4)=(-(T98*y(18)*T96*T586));
  g1(9,12)=(-(T586*y(18)*y(4)*T96*getPowerDeriv(y(12),params(10)-1,1)));
  g1(9,13)=(-(T586*T98*y(18)*y(4)*getPowerDeriv(y(13),params(10),1)));
  g1(9,18)=(-(T586*T98*y(4)*T96));
  g1(9,39)=1-T586*params(2)*params(11)*getPowerDeriv(y(39),1+params(10)*params(6),1);
  g1(10,12)=T105*T740-T105*params(11)*T740;
  g1(10,13)=T104*T770-params(11)*T104*T770;
  ...
  g1(14,12)=T751-params(17)*T751;
  g1(14,34)=(-((1-params(17))*getPowerDeriv(y(34),1-params(16),1)));
  g1(15,4)=(-(T168*T164*T158*T589));
  g1(15,11)=1;
  ...
  g1(16,30)=(-(T168*T164*T175*y(23)*exp(y(40))*params(20)*T893));
  g1(16,40)=(-(T168*T164*y(23)*exp(y(40))*params(20)*T172*T175));
  g1(17,4)=(-(T168*T185*T172*y(23)*exp(y(40))*params(21)*T589));
  g1(17,14)=1;
  g1(17,23)=(-(T168*T185*T160*T172*exp(y(40))*params(21)));
  g1(17,30)=(-(T168*T185*T160*y(23)*exp(y(40))*params(21)*T893));
  g1(17,40)=(-(T168*T160*T172*y(23)*exp(y(40))*params(21)*T185));
  g1(18,4)=(-(T195*T164*T172*y(23)*exp(y(40))*params(22)*T589));
  g1(18,15)=1;
  g1(18,23)=(-(T195*T164*T160*T172*exp(y(40))*params(22)));
  g1(18,30)=(-(T195*T164*T160*y(23)*exp(y(40))*params(22)*T893));
  ...
  g1(29,41)=T3;
  g1(29,47)=T989-params(27)*T989;
  g1(30,16)=1;
  g1(30,47)=T3;
  g1(31,4)=(-(T168*T164*exp(y(40))*T172*T589));
  g1(31,5)=1;
  g1(31,30)=(-(T168*T164*T160*exp(y(40))*T893));
  ...
  g1(44,6)=params(42)*T658;
  g1(44,7)=params(42)*T665;
  g1(44,46)=1;
  g1(45,5)=(-(params(41)*((y(5)*(-y(48))-(y(6)-y(7)-y(5)*y(48)))/(y(5)*y(5))-(-((y(6))-(y(7))))/((y(5))*(y(5))))));
  g1(45,6)=(-(params(41)*T658));
  g1(45,7)=(-(params(41)*T665));
