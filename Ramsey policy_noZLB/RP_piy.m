...
erase_compiled_function('RP_piy_static');
erase_compiled_function('RP_piy_dynamic');
M_.orig_eq_nbr = 130;
M_.eq_nbr = 130;
M_.ramsey_eq_nbr = 0;
...
M_.osr.variable_weights(5,5) = 1;
M_.osr.variable_indices = [M_.osr.variable_indices; 5];
M_.osr.variable_weights(12,12) = 1;
M_.osr.variable_indices = [M_.osr.variable_indices; 12];
M_.osr.variable_weights(5,12) = 0.5;
M_.osr.variable_indices = [M_.osr.variable_indices; 5; 12];
M_.osr.param_names = char('lam_pi','lam_y');
M_.osr.param_names = cellstr(M_.osr.param_names);
M_.osr.param_indices = zeros(length(M_.osr.param_names), 1);
M_.osr.param_indices(1) = 28;
M_.osr.param_indices(2) = 29;
M_.osr.param_bounds = [-inf(length(M_.osr.param_names), 1), inf(length(M_.osr.param_names), 1)];
M_.osr.param_bounds(strcmp(M_.osr.param_names, 'lam_pi'), :) = [1, 1.9];
M_.osr.param_bounds(strcmp(M_.osr.param_names, 'lam_y'), :) = [0, 1];
options_.nograph = 1;
options_.osr.opt_algo = 9;
var_list_ = char();
oo_.osr = osr(var_list_,M_.osr.param_names,M_.osr.variable_indices,M_.osr.variable_weights);
save('RP_piy_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('RP_piy_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('RP_piy_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('RP_piy_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('RP_piy_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('RP_piy_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('RP_piy_results.mat', 'oo_recursive_', '-append');
end
