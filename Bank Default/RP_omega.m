...
M_.exo_names = char(M_.exo_names, 'macropru_shk');
M_.exo_names_tex = char(M_.exo_names_tex, 'macropru\_shk');
M_.exo_names_long = char(M_.exo_names_long, 'macropru_shk');
M_.endo_names = 'ch';
...
M_.osr.variable_weights(51,51) = 1;
...
var_list_ = char('ch','Ce','Cb','H','Y','I','bigN','bigA','smallb','q','rk','infl','w_h','w_e','w_b','Rd','Ra','lam','mu','p','TL','mc','s','mgrowth','expinfl','smalld','gY','totC','u','keff','K','Kb','Ke','gammag','alpha','rnot','util','welf','BVaR');
