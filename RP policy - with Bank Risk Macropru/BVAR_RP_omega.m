...
erase_compiled_function('BVAR_RP_omega_static');
erase_compiled_function('BVAR_RP_omega_dynamic');
M_.orig_eq_nbr = 133;
M_.eq_nbr = 133;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state = zeros(133, 1);
M_.maximum_exo_lag = 0;
M_.maximum_exo_lead = 0;
oo_.exo_steady_state = zeros(4, 1);
M_.params = NaN(49, 1);
M_.NNZDerivatives = [377; 346; -1];
...
pi_ss = M_.params( 9 );
M_.params( 27 ) = 0.926979;
lam_r = M_.params( 27 );
M_.params( 28 ) = 1.43471;
lam_pi = M_.params( 28 );
M_.params( 29 ) = 0.267282;
lam_y = M_.params( 29 );
Rd_temp = pi_ss/bet;
M_.params( 10 ) = 21.0;
xi_w = M_.params( 10 );
...
M_.osr.variable_weights(132,132) = 1;
M_.osr.variable_indices = [M_.osr.variable_indices; 132];
M_.osr.param_names = char('omega');
M_.osr.param_names = cellstr(M_.osr.param_names);
M_.osr.param_indices = zeros(length(M_.osr.param_names), 1);
M_.osr.param_indices(1) = 41;
M_.osr.param_bounds = [-inf(length(M_.osr.param_names), 1), inf(length(M_.osr.param_names), 1)];
M_.osr.param_bounds(strcmp(M_.osr.param_names, 'omega'), :) = [(-100), 0];
options_.nograph = 1;
options_.osr.opt_algo = 2;
var_list_ = char();
oo_.osr = osr(var_list_,M_.osr.param_names,M_.osr.variable_indices,M_.osr.variable_weights);
save('BVAR_RP_omega_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('BVAR_RP_omega_results.mat', 'oo_recursive_', '-append');
end
