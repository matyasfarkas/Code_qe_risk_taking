...
omega = 0;     varsigma = 0.00000000000000;  mu_ss = 0.02500000000000;
...
alpha = 1 - (1-alpha_ss) - ((I-bigN)/Y-(steady_state(I)-steady_state(bigN))/steady_state(Y))*varsigma ; gammag = steady_state(gammag)+2.5; I =gammag * bigA + bigN + CBBS*Y;  gammag = 1 + (q*Ra/Rd)*(delalpha*bigR-smallb-mu/q)/mu - Ra*delalpha/alpha; CBBS =   CBBSp*( (bigA-steady_state(bigA))/steady_state(Y) + (bigN-steady_state(bigN))/steady_state(Y)	 ) + lqe/steady_state(Y);
